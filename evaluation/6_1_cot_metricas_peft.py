...
def main():
    ...
    REPO_HF_NAME = "/home/cluny.rojas/my_project/generatejunits/src/gemma/gemma-2-2b_dataset350k_20241119_182859"
    ...
    model, tokenizer = load_model_and_tokenizer(BASE_MODEL_NAME, is_peft=True, peft_repo=REPO_HF_NAME)
    ...
    init_wandb("EvaluationTestCases_CSV", HF_NAME, FILE_NAME)
    device = init_device()
