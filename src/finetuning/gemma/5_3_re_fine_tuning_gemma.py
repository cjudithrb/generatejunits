...
FILE_PATH = '/home/cluny.rojas/my_project/generatejunits/data/dataset350k.tsv'
...
df = df[df['num_characters_test'] <= 1200]
print(df.shape)
...
def prepare_datasets(dataset: Dataset, tokenizer, test_size: float=0.2, validation_size: float=0.9995):
...
def configure_training(resume=False):
    ...
    training_args = TrainingArguments(
    	...
    	num_train_epochs=3, #Disminuye
    	learning_rate=1e-6, #Disminuye
    	per_device_train_batch_size=4,
    	gradient_accumulation_steps=16, #Disminuye
...
if __name__ == "__main__":
    ...
    init_wandb(peft_training_args, PROJECT_NAME_WANDB, MODEL_NAME, FILE_NAME, current_datetime, resume=True) #gemma
...
print("BASE MODEL BERTScore:", base_model_results_bertscore)
print("PEFT MODEL BERTScore:", peft_model_results_bertscore)
...
print("\nPEFT MODEL SacreBLEU:", peft_model_results_sacrebleu)
...
print("\nPEFT MODEL CodeBLEU:", peft_model_results_codebleu)


"""### **5.6. Evaluando con CodeBERTScore**"""
...
wandb.log({
    "Test/Base_Model_BERTScore": base_model_results_bertscore['f1'],
    "Test/PEFT_Model_BERTScore": peft_model_results_bertscore['f1'],
    ...
    #"Test/Base_Model_CodeBERTScore_F1": f1_base.mean().item(),
    #"Test/PEFT_Model_CodeBERTScore_F1": f1_peft.mean().item(),
    #"Test/Base_Model_CodeBERTScore_F3": f3_base.mean().item(),
    #"Test/PEFT_Model_CodeBERTScore_F3": f3_peft.mean().item()
})
