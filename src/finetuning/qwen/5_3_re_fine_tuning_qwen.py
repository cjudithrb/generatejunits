...
def init_wandb(training_args, project_name, model_name, file_name, current_datetime, resume=False):
    # Si estamos resumiendo, intentamos obtener el ID de la última ejecución
    if resume:
        try:
...
if __name__ == "__main__":
    ...
    init_wandb(peft_training_args, PROJECT_NAME_WANDB, MODEL_NAME, FILE_NAME, current_datetime, resume=True) #
